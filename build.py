...
def unity_build(args) -> None:  # noqa: ANN001
    ...
    remove("unity/Assets/Scripts/AUTD3Sharp.Link.SOEM.csproj")
    remove("unity/Assets/Scripts/AUTD3Sharp.Link.SOEM.nuspec")
...
def util_update_ver(args) -> None:  # noqa: ANN001
    ...
    nuspec = Path("src/AUTD3Sharp.Link.SOEM.nuspec")
